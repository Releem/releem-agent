...
func TestInnoDBClusterSetGoldenContract(t *testing.T) {
	...
	assertGoldenRelationContract(t, topology, []goldenRelationIdentity{
		{relationType: "async_replication", groupKey: "primary-writer-uuid", memberKey: "secondary-writer-uuid"},
		{relationType: "group_replication", groupKey: "group-secondary", memberKey: "secondary-writer-uuid"},
		{relationType: "innodb_cluster", groupKey: "cluster-secondary", memberKey: "secondary-writer-uuid"},
		{relationType: "innodb_clusterset", groupKey: "clusterset-inventory", memberKey: "secondary-writer-uuid"},
	})
